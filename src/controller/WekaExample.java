...
// the class gives an example of:
// loading arff or csv files
...
public class WekaExample{
	...
	public static void main(String[] args) {
		WekaExample app = new WekaExample();
		try {
			app.singleBuildExample();
		} catch (Exception e) {			
			e.printStackTrace();
		}
	}	
	...
	private void singleBuildExample() throws Exception {
		...
		// if you have CSV data then use this method
		// it reads the CSV file and also converts and saves it as an arff file
		// Sets class attribute as the last attribute 
		
		//Instances data = readCSVFile("irisData.csv", "irisData.arff");
	  ...
	  /* Use this code if you want to read training/test data directly from a file */
	...
	public static Instances readCSVFile(String csvFileName, String arffFileName) throws IOException{
