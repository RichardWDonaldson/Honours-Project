...
public class MLP extends Settings {
	...
	public MLP(String algorithmType, String structure, double iterations, double learningRate, double momentum,
	...
	public String toString() {
		return "MLP [structure=" + structure + ", iterations=" + iterations + ", learningRate=" + learningRate
				+ ", momentum=" + momentum + ", seed=" + seed + ", validationThreshold=" + validationThreshold
